...
class AlgorithmsAssignment : Game
{
	...
	//common settings
	private const int SCALE = 4;                // MIN OF 2
	private const int MIN_ROOM_SIZE = 18;       //TODO: use this setting in your dungeon generator
	...
	public void Update()
	{
		...
		while (_dungeon.rooms.Count > 100000 || _dungeon.rooms.Count < 0)
		{
			_dungeon.Generate(MIN_ROOM_SIZE);
			_graph.Generate();
		}
